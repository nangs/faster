...
export default class ArchGauge extends Component {
    constructor(props, context) {
        super(props, context);
        this.renderArcGauge = this.renderArcGauge.bind(this);
        this._animateArrow = this._animateArrow.bind(this);
        this._drawArrow = this._drawArrow.bind(this);
        this._mkCmd = this._mkCmd.bind(this);
        this._percToDeg = this._percToDeg.bind(this);
        this._percToRad = this._percToRad.bind(this);
        this._degToRad = this._degToRad.bind(this);
